...
//            directory = LuceneUtils.openFSDirectory(indexPath);
            directory = FSDirectory.open(Paths.get("E:\\DEVELOPER\\Workspaces\\eclipse13\\lucene\\luceneIndex\\"));
            // 内存存储
